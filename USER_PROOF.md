...
| # | Name | Wallet Address | Action | Transaction Hash | Stellar Expert | Status |
|---|------|---------------|--------|-----------------|----------------|--------|
| 1 | Rishi Nirgude | `GDTFEGG6CM4OPTVM4MTKDMY3JFBYQS6AQRMM5DVN36AYAYJXELMZYA5B` | Connected wallet + contributed to circle | `4db83e8e...084fcc` | [View](https://stellar.expert/explorer/testnet/tx/4db83e8e4b09e056b80bfc541f0cb61d1a9f2b316abbe759847f299804084fcc) | ✅ Confirmed |
...
1. Click any "View on Stellar Expert" link above
2. Confirm the transaction is on **Stellar Testnet**
3. Check the source account matches the wallet address in the table
4. Confirm transaction type is a **payment** operation

**Network:** Stellar Testnet  
**Explorer:** https://stellar.expert/explorer/testnet  
**App:** https://frontend-coral-nine-24.vercel.app  
